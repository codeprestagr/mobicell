                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="px-2 py-2 whitespace-nowrap text-end text-sm font-medium flex justify-end gap-3">
                                        @if(!$user->isSuperAdmin() || auth()->id() !== $item->id)
                                            @if($user->isSuperAdmin() || $user->can('permissions.delete'))
                                            ...
                                            @endif
                                            @if($user->isSuperAdmin() || $user->can('permissions.edit'))
                                                <div class="hs-tooltip">
                                                    <a href="{{ route('permissions.edit', $item) }}" data-fc-placement="bottom"
