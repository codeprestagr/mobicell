                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="px-2 py-2 whitespace-nowrap text-end text-sm font-medium flex justify-end gap-3">
                                        ...
                                        @endif
                                            ...
                                            @if($user->isSuperAdmin() || $user->can('incomes.categories.edit'))
                                            <div class="hs-tooltip">
                                                <a href="{{ route('incomes.categories.edit', $item) }}" data-fc-placement="bottom" class=" h-8 w-8 rounded-full bg-gray-200 flex justify-center items-center" >
