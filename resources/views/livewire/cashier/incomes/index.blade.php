<div>
    <div class="flex items-center justify-between flex-wrap gap-2 mb-6">
        ...
        @if($user->isSuperAdmin() || $user->can('incomes.categories.create'))
            <div>
                @include('livewire._partials.button_create',[
                    'text' => __('Add new'), 'url'=> route('incomes.categories.create')])
            </div>
        @endif
    ...
    <div class="card overflow-hidden p-6">
        ...
        @if(count($items))
            @include('livewire.cashier.incomes._partials.data')
        @else
