    ...
    <div class="flex items-center gap-3">
        ...
        <div class="flex-grow">
            <div class="text-sm text-yellow-600 font-medium flex justify-start items-center gap-2">
                <span class="font-medium"><b>{{__('No available shipping methods were found!')}}</b></span>
                {{__('Please synchronize the application with Prestashop.')}}

                @if($btn)
                    <a href="{{route('admin.shop.shippings')}}" class="btn bg-primary text-white font-medium">
